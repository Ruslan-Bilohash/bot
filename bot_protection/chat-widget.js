// chat-widget.js — Modern secure version (XSS-safe, no eval, strict mode)
(function () {
    'use strict';
    ...
    header.innerHTML = `
        <div style="display:flex; align-items:center; gap:14px;">
            ...
            <div>
                ...
                <div style="font-size:13px;opacity:0.95;">PHP Developer • online</div>
            </div>
        </div>
        <div style="display:flex; gap:12px;">
            <button id="refresh" title="Refresh chat" style="background:rgba(255,255,255,0.3);color:white;border:none;border-radius:50%;width:36px;height:36px;cursor:pointer;font-size:18px;">↻</button>
